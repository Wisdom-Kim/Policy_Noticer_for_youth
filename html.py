  ...
  <div dir="ltr" class="es-wrapper-color" lang="en" style="background-color:#FAFAFA"><!--[if gte mso 9]>
   ...
   <table class="es-wrapper" width="100%" cellspacing="0" cellpadding="0" role="none" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;padding:0;Margin:0;width:100%;height:100%;background-repeat:repeat;background-position:center top;background-color:#FAFAFA">
    ...
    def insert_table(self,data):
        # data 인자를 통해 데이터 파싱 후 테이블 html 코드 반환
        #html을 담을 변수
        temp=''
        ...
        temp+=f"""
                <table cellpadding="0" cellspacing="0" align="left" class="es-left" role="none" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;float:left">
                    ...
                    <table cellpadding="0" cellspacing="0" width="100%" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:separate;border-spacing:0px;border-left:1px solid #efefef;border-right:1px solid #efefef;border-top:1px solid #efefef;border-bottom:1px solid #efefef;border-radius:5px" role="presentation">
                        <tr>
                        <td align="center" style="padding:0;Margin:0;font-size:0px"><img class="adapt-img" src="https://eiciojs.stripocdn.email/content/guids/CABINET_887f48b6a2f22ad4fb67bc2a58c0956b/images/37161617892813768.png" alt="" style="display:block;font-size:14px;border:0;outline:none;text-decoration:none" height="200"></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                        <td align="center" class="es-m-txt-c" style="Margin:0;padding-top:5px;padding-bottom:5px;padding-right:10px;padding-left:10px"><h2 style="Margin:0;font-family:arial, 'helvetica neue', helvetica, sans-serif;mso-line-height-rule:exactly;letter-spacing:0;font-size:26px;font-style:normal;font-weight:bold;line-height:31px;color:#333333">$35 <span style="color:#999999"><s style="text-decoration:line-through">$55</s></span></h2></td>
                        </tr>
                        <tr>
            ...
            for i in range(0,len(data_list),2):
                ##2개씩 출력
                  self.html+=f"""
                            ...
                            {self.insert_table(data_list[i])}
                            {self.insert_table(data_list[i+1])}
                            </td>
                            </tr>
                            """
        except Exception:
